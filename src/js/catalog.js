...
var uzToRu = {
  ...
  "15 yil kafolat": "15 лет гарантии",
  "Chidamli va mustahkam": "Прочный и долговечный",
  "Tabiiy ko'rinish": "Натуральный вид",
  "Yuqori mustahkamlik": "Высокая прочность",
  "Chizilmaydigan": "Не царапается",
  "Namlikka chidamli": "Влагостойкий",
  "Premium sifat": "Премиум качество",
  "Marmar effekt": "Эффект мрамора",
  "Uzoq xizmat muddati": "Долгий срок службы",
  "Ekologik toza": "Экологически чистый",
  "Kam parvarish": "Минимальный уход",
  // Kvarts applications
...
function openStoneModal(stone) {
  ...
  modalBody.innerHTML = `
    <div class="modal-image-container" id="galleryContainer">
      ...
      ${!(stone.type === 'granit' && stone.images.length >= 1 && !stone.images[0].includes('supabase.co') && stone.images.length <= 1) ? `
